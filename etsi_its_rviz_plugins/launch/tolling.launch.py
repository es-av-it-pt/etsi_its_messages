...
def generate_launch_description_with_resolved_launch_args(launch_context):
    ...
    return [
        ...
        Node(
            ...
            arguments=["-d", os.path.join(get_package_share_directory("etsi_its_rviz_plugins"), "config/tolling.rviz")],
            output="screen",
        ),
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("lat", default_value="38.819450", description="reference position latitude (map frame)"),
        DeclareLaunchArgument("lon", default_value="-9.188336", description="reference position longitude (map frame)"),
