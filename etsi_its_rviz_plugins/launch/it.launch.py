...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("lat", default_value="40.6341605", description="reference position latitude (map frame)"),
        DeclareLaunchArgument("lon", default_value="-8.6599406", description="reference position longitude (map frame)"),
